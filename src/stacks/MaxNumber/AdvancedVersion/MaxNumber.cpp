...
// we needn't check from beginning, during last scan, we already know [9, 3, 2] is monotonically non-increasing,
// so we check 8 directly, since 8 > 2, we drop 2, the result is [9, 3, 8, 7, 6]. 
...
// The result is [9, 8, 7], For i==2, we drop last number 7 and have [9, 8]. 
